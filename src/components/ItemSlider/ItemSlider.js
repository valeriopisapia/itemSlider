...
export default class ItemSlider extends React.PureComponent {
  ...
  _prevButton () {
    ...
    const className = `item-slider__prev-btn-item${inactivePrev ? ' __inactive' : ''}`

    return (
      <div className="item-slider__prev-btn">
        <div
          className="item-slider__prev-btn-wrapper"
          onMouseEnter={this._onMouseEnterAutoPlayHandler}
          onMouseLeave={this._onMouseLeaveAutoPlayHandler}
        >
          <p onClick={this._slidePrev}><i className="fas fa-arrow-left"></i></p>
        </div>
      </div>
    )
  }
  ...
  _nextButton () {
    ...
    const className = `item-slider__next-btn-item${inactiveNext ? ' __inactive' : ''}`

    return (
      <div className="item-slider__next-btn">
        <div
          className="item-slider__next-btn-wrapper"
          onMouseEnter={this._onMouseEnterAutoPlayHandler}
          onMouseLeave={this._onMouseLeaveAutoPlayHandler}
        >
          <p onClick={this._slideNext}><i className="fas fa-arrow-right"></i></p>
        </div>
      </div>
    )
  }
  ...
  _slideIndexInfoComponent = () => {
    ...
    return (
      <div className="item-slider__slide-info">
        <span className="item-slider__slide-info-item">{currentIndex}</span>
        <span className="item-slider__slide-info-item item-slider__slide-info-item--separator">/</span>
        <span className="item-slider__slide-info-item">{slidesLength}</span>
      </div>
    )
  }
  ...
  _renderDotsNavigation (state) {
    ...
    return (
      <ul className="item-slider__dots">
        {
          slides.map((item, i) => {
            if (i < dotsLength) {
              ...
              return <li
                ...
                onMouseEnter={this._onMouseEnterAutoPlayHandler}
                onMouseLeave={this._onMouseLeaveAutoPlayHandler}
                className={`item-slider__dots-item${this._getActiveSlideIndex() === i ? ' __active' : ''}`}
              />
            }
          })
        }
  ...
  _renderPlayPauseButton () {
    return (
      <div className="item-slider__play-btn">
        <div className="item-slider__play-btn-wrapper">
          <div
            onClick={this._playPauseToggle}
            className={`item-slider__play-btn-item${this.state.isPlaying ? ' __pause' : ''}`}
          />
        </div>
      </div>
    )
  ...
  _setItemClassName = (i) => {
    ...
    return 'item-slider__stage-item' + isActive + isCloned + isAnimated
  }
    ...
    return (
      <Wrapper>
        <div className="item-slider">
          ...
          >
            <div
              className="item-slider__wrapper"
              onMouseEnter={this._onMouseEnterAutoPlayHandler}
              onMouseLeave={this._onMouseLeaveAutoPlayHandler}
            >
              <ul style={stageStyle} className="item-slider__stage" ref={this._getStageComponentNode}>
